...
function Footer({ color }) {
  return (
    <footer
      className="gap-1 bp:px-12  absolute bp:bottom-1 -bottom-96 
    bp:flex-row flex flex-col justify-between items-center p-1 overflow-x-hidden"
    >
      ...
      <div className="-order-1 bp:order-none flex justify-center">
        <p className="text-white  w-3/5 pb-4 text-justify">
