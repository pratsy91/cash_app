...
function Home() {
  return (
    <>
      <div className="flex flex-col text-center bp:px-0 px-10 items-center relative top-40">
        ...
        <p className="text-scash bp:text-cash text-white bp:-bottom-56  font-black absolute -bottom-20">
          APP
        </p>
      </div>
